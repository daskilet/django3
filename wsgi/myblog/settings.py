...
if ON_OPENSHIFT:
   DATABASES = {
        ...
        'NAME': 'daskilet_admin',                      # Or path to database file if using sqlite3.
        'USER': 'daskilet_admin',                      # Not used with sqlite3.
   ...
   DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': 'third_for_django', # Or path to database file if using sqlite3.
...
SECRET_KEY = '*@q@4fgf%e4dpn1ls3kc1kl#ehipm9r9g$bo9y6-r9=a9(*$7v'
